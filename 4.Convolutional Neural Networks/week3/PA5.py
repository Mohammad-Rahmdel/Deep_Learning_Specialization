...
Each bounding box is represented by 6 numbers (pc,bx,by,bh,bw,c) (pc,bx,by,bh,bw,c) as explained above. 
If you expand cc into an 80-dimensional vector, each bounding box is then represented by 85 numbers. 
...
def yolo_filter_boxes(box_confidence, boxes, box_class_probs, threshold = .6):
    ...
    box_classes = tf.math.argmax(box_scores, axis=-1)  #gives index of the maximum value
    box_class_scores = tf.reduce_max(box_scores, axis=-1)  #gives the maximum values
