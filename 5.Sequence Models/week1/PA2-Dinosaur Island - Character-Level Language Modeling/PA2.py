...
# # to realize choice function
# np.random.seed(0)
# p = np.array([0.1, 0.0, 0.7, 0.2])
# index = np.random.choice([0, 1, 2, 3], p = p.ravel())
# print(index)
# index = np.random.choice(p, p = p.ravel())
# print(index)
...
def sample(parameters, char_to_ix, seed):
    ...
    while (idx != newline_character and counter != 50):
        ...
        idx = np.random.choice(list(range(vocab_size)), p = y.ravel())  # returns the index of element with the maximum probability
